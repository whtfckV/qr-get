...
const reports: Record<reposrtsTypes, Report> = {
  ...
  report_sales_returns: { title: 'Отчет по партнерам', icon: 'mdi-scale-balance', link: '/reports/SellersReturn' },
  report_disput: { title: 'Отчет по диспутам', icon: 'mdi-fire', link: '/reports/Disput' },
  table_disput: { title: 'Таблица диспутов', icon: 'mdi-table', link: '/Disputs' },
};

// const tables: Record<tablesTypes, Report> = {
// }
